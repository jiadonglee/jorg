...
# Korg.jl compatible aliases (CGS units)
c_cgs = SPEED_OF_LIGHT
hplanck_cgs = PLANCK_H  
kboltz_cgs = BOLTZMANN_K
me_cgs = ELECTRON_MASS
mp_cgs = PROTON_MASS
e_cgs = ELEMENTARY_CHARGE
sigma_thomson = THOMSON_SCATTERING
pi = PI

# Korg.jl compatible derived constants
hplanck_eV = PLANCK_H / EV_TO_ERG  # eV s
kboltz_eV = BOLTZMANN_K / EV_TO_ERG  # eV K^-1
